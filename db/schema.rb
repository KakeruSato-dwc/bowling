...
ActiveRecord::Schema.define(version: 2023_12_04_084154) do
  ...
  create_table "reservations", force: :cascade do |t|
    ...
    t.integer "num_adults", default: 0, null: false
  ...
  create_table "start_time_collections", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  create_table "start_times", force: :cascade do |t|
    t.time "start_time", null: false
    t.integer "num_available_lanes", default: 24, null: false
